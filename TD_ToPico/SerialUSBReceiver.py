...
output_analog_led_pin = PWM(Pin(15))
output_analog_led_pin.freq(10000)
    ...
    while True:
        ...
        if inputOption == 'BYTE':           # NON-BLOCKING input one byte at a time
            ...
            if buffLine:                    # if there is...
                ...
                msg = str(buffLine).split(',')
                
                print("msg length:" + str(len(msg)))
                      
                if len(msg) == 5 and msg[0] == "start" and msg[4] == "end":
                    value1 = int(msg[1])
                    value2 = int(msg[2])
                    value3 = int(msg[3])
                    #print(value1)
                    
        output_analog_led_pin.duty_u16(value1)
                    #print(value2)
                    #print(value3)
